<template>
  <li
    ...
    class="flex flex-col bg-white xs:rounded-xl shadow-md -mx-4 xs:-mx-0 hover:shadow-lg"
  >
    <router-link
    ...
    <div class="p-4 flex-grow flex flex-col">
      ...
      <nav class="mb-2">
        <small class="flex flex-wrap -m-1">
          <router-link
            class="m-1 leading-tight underline"
      ...
      <div class="flex items-center mt-auto">
        ...
        <button
          class="flex items-center bg-primary-400 py-2 px-3 ml-auto rounded-md text-white hover:bg-primary-500"
